...
static const unsigned int gapppx    = 0;
...
static const char *fonts[]          = { "Fixedsys:size=10", "fontawesome:size=10" };
static const char col_gray1[]       = "#000000";
static const char col_gray2[]       = "#beaa9b";
static const char col_gray3[]       = "#303030";
static const char col_gray4[]       = "#4b4b4c";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray2, col_gray1, 0},
...
static const char *term[]  = { "kitty", 0};
static const char *dmenu[] = { "dmenu_run", 0};


static const char *ss[] = { "screenshot", 0};
static const char *obs[] = { "obs", "--startreplaybuffer", 0};
static const char *browser[] = { "librewolf-bin", 0};
static const char *galc[] = { "galculator", 0};
static const char *pcmanfm[] = { "pcmanfm", 0};
static const char *pavu[] = { "pavucontrol", 0};
static const char *keepass[] = { "keepassxc", 0};
...
static const char *daily[] = { "kitty", "-e", "vim", "daily", 0};
static const char *longjump[] = { "kitty", "-e", "python3", "/m/git/bin/lj1.py", 0};
static const char *cs[] = { "kitty", "-e", "cs2-autoaccept-linux", 0};
...
static const char *res1[] = { "sh", "/m/git/bin/res1.sh", 0};
static const char *res2[] = { "sh", "/m/git/bin/res2.sh", 0};
...
static const Key keys[] = {
	...
	{ MOD,                       XK_n,	spawn,          {.v = obs } },
	{ MOD,                       XK_o,	spawn,          {.v = galc } },
	{ MOD,                       XK_b,	spawn,          {.v = pcmanfm } },
	{ MOD,                       XK_v,      spawn,          {.v = pavu } },
	{ MOD,                       XK_g,      spawn,          {.v = keepass } },
	{ MOD,                       XK_x,      spawn,          {.v = daily } },
	{ MOD,                       XK_c,      spawn,          {.v = longjump } },
	{ MOD,                       XK_z,      spawn,          {.v = cs } },
	{ MOD,                       XK_u,      spawn,          {.v = mutemic } },
